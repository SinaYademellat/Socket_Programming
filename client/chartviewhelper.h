...
/**
 * @brief حالت‌های ترسیم نمودار
 *
 * مقادیر ممکن:
 * - Line: نمودار خطی (Line) [پیش‌فرض]
 * - Bar: نمودار ستونی (Bar)
 */
...
private:
     ...
     */
    void appendMaskedSeriesByLowerBound(QList<float>& HitLine_X,
     ...
     */
    void _plotChartWithMinFilter_BarChar(QChart *chart_input,
     ...
     * @param low_colorCode کد رنگ کران پایین
     */
    void _plotChartWithMinFilter_LineChar(QChart *chart_input,
                                          const QList<int>& DataForPlotIs,
                                          int low_bound, int low_colorCode );
     ...
     */
    void appendMaskedSeriesByUpperBound(QList<float>& HitLine_X,
                                        QList<float>& X_low, QList<int>&Y_low,
                                        QLineSeries *upperMask, QLineSeries *lowMask,
                                        int Threshold_max);
    //  ---------> Max
     ...
     * @see	_plotChartWithMinFilter_BarChar
     */
    void _plotChartWithMaxFilter_BarChar(QChart *chart_input,
                                         const QList<int>& DataForPlotIs,
     ...
     * @see	_plotChartWithMinFilter_LineChar
     */
    void _plotChartWithMaxFilter_LineChar(QChart *chart_input,
                                          const QList<int>& DataForPlotIs,
                                          int Up_bound, int Up_colorCode );
     ...
     * @see	_plotChartWithMinFilter_BarChar
     */
    void _plotChartWithMin_and_MaxFilte_BarChar(QChart *chart_input,
                                                const QList<int>& DataForPlotIs,
                                                int low_bound, int low_colorCode,
                                                int Up_bound, int Up_colorCode);
     ...
     * @see	_plotChartWithMinFilter_LineChar
     */
    void _plotChartWithMin_and_MaxFilte_LineChar(QChart *chart_input,
                                                 const QList<int>& DataForPlotIs,
                                                 int low_bound, int low_colorCode,
                                                 int Up_bound, int Up_colorCode);
