...
void GuiManager::showMainForm(QMainWindow *window, QFrame *loginFrame, QList<QFrame *> mainForms ,QList<QColor>  colorsFor_colorCombo ,  BasicFunctions mybasicfunctis,
                              QComboBox *colorCombox_1_Max , QComboBox *colorCombox_2_Min , QSlider *horizontalSlider_FPS, QLabel *label_FPSValue)
{
    ...
    mybasicfunctis.AddColorItemToQcomBox(colorCombox_1_Max , colorsFor_colorCombo);
    mybasicfunctis.AddColorItemToQcomBox(colorCombox_2_Min , colorsFor_colorCombo);
    // ------------
    mybasicfunctis.SetGuiBlineBar(horizontalSlider_FPS,1,100,1,100);
    // ------------
